                ...
                <div className="space-y-2">
                  {day.visits.map((visit) => (
                    <Link
                      ...
                      className="block p-2 rounded border-l-4 bg-brand-primary/10 hover:bg-brand-primary/20 border-brand-primary transition-colors"
                    >
      ...
      <div className="mt-8">
        <ActivityFeed
          ...
          onMessageCustomer={(visit) => {
            // Navigate to customer page for messaging via portal
            window.location.href = `/admin/customers/${visit.customer_id}`
          }}
        />
      </div>
    </div>
