...
export default function EditRedwoodsCustomerPage() {
    ...
    fetch(`/api/redwoods/customers/${customerId}`)
      ...
      .then(data => {
        ...
        setFormData({
          ...
          phone: data.phone || '',
          email: data.email || '',
          agreed_price_cents: (data.agreed_price_cents / 100).toString(),
          payment_frequency: data.payment_frequency || 'per_visit',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/redwoods/customers/${customerId}`, {
        method: 'PATCH',
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <h1 className="text-3xl font-bold text-text-primary">Edit Customer</h1>
        <p className="text-text-muted mt-1">Update customer information</p>
      </div>
          ...
          <div>
            <label className="flex items-center gap-2">
              <input
                ...
                className="w-4 h-4 text-brand-primary border-border rounded focus:ring-2 focus:ring-brand-primary"
              />
              <span className="text-sm font-semibold text-text-primary">Active Customer</span>
            </label>
            <p className="text-sm text-text-muted mt-1">
              Uncheck to pause service for this customer
            </p>
          </div>
